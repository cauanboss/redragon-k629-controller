...
import { StaticEffect } from '../src/effects/static.js';
import { RainbowEffect } from '../src/effects/rainbow.js';
import { WaveEffect } from '../src/effects/wave.js';
import { getEffect, listEffects } from '../src/effects/index.js';
import { KeyLayout } from '../src/layout.js';
...
describe('Effects Registry', () => {
  ...
  it('listEffects() contains all three built-in effects', () => {
